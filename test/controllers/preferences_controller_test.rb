...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post preferences_url, params: { preference: { order_id: @preference.order_id, preference_id: @preference.preference_id } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { order_id: @preference.order_id, preference_id: @preference.preference_id } }
